...
# したこと
## 認証基盤刷新リリース
今月6月に弊社が運用しているSaaSの認証基盤を一つにまとめるリリースを行いました。マイクロサービスアーキテクチャへの第一歩って感じです。
...
しかし、S3 Vectorsはハイブリット検索をサポートしておらず、セマンティック検索のみになってしまっているため若干精度は落ちているかもしれません。
...
情報処理安全確保支援士試験、登録してバッチが欲しいですが、バッチのために高額な費用を払えないと思うので未登録のまま行きます笑。
...
今回解説したような実際の業務を行うことができる、有償であるなどメリットたくさんあるので、ぜひ見てみてください！
